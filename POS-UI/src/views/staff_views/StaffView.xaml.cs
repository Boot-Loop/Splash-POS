...
namespace UI.Views
{
    ...
    {
        private StaffViewModel _staff_view_model;
        public StaffView(HomeViewModel home_view_model) {
            InitializeComponent();
            this._staff_view_model = new StaffViewModel(home_view_model);
            this.DataContext = _staff_view_model;
            CoreApp.logger.log("Staff view successfully initialized!");
        }
