...
{
    public abstract class ReportDoc
    {
        public void exportDataTableToPdf(DataTable data_table, String pdf_path, string header, string from, string to, string footer_text) {
            ...
            Font font_footer = new Font(base_font_footer, 14, 2, Color.BLACK);
            paragraph_footer.Alignment = Element.ALIGN_RIGHT;
            paragraph_footer.Add(new Chunk(footer_text, font_footer));
